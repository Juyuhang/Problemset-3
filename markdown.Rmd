...
- \lhead{}
- \chead{}
- \rhead{Federal Presidential Elections 2020} usepackage{setspace} doublespacing
includes:
...
surveydata <- read_csv("C:/Users/sa/Documents/MI2010/survey_data.csv")

censusdata <- read_csv("C:/Users/sa/Documents/MI2010/census_data.csv")
...
The model can be summarised as shown below. The logistic model was preferred since we aimed at getting a binary output. The output would simply state whether President Trump would win the election or lose, presumably to Joe Biden[@larsen2000]. 
...
# Results
The model predicted that the probability of a person voting for President Trump was: ```{r}mean(censusdata$estimate)```; regardless of his or her age, income, or race. 
